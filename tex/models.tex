...
Daudzvalodu valodu modeļi, piemēram, mBERT un XLM, tiek apmācīti uz vairākām valodām, un tas nodrošina efektīvu starp-valodu zināšanu pārnesi. Tie ir ievērojami uzlabojuši veikumu starpvalodu izpratnes (cross-lingual understanding) (\textit{attention layer})uzdevumos, tostarp starpvalodu dabiskās valodas inference, atbildēs uz jautājumiem un nosaukto entītiju atpazīšanā \cite{conneau2020}.